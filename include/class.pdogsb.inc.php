...
class PdoGsb{   		
      	...
      	private static $bdd='dbname=ProjetGSB';   		
...
*/
	public function getTousLesFraisForfait($idVisiteur,$mois){
...
*/
	public function getLesFraisForfait($idVisiteur, $mois){
		...
		LigneFraisForfait.quantite as quantite,LigneFraisForfait.montant as montant, LigneFraisForfait.mois as date, LigneFraisForfait.idVisiteur as idVisiteur
...
*/
	public function majFraisForfait($idVisiteur, $mois, $lesFrais){
		...
		foreach($lesCles as $unIdFrais){
			...
			$req = "update LigneFraisForfait set LigneFraisForfait.quantite = $qte,LigneFraisForfait.montant=LigneFraisForfait.montant*$qte
			where LigneFraisForfait.idVisiteur = '$idVisiteur' and ligneFraisForfait.mois = '$mois'
